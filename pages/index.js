			...
			<main className={styles.main}>
...

				{
					function () {
						...
						const sections = [
                            <section key={1} className={styles.breakfastSection}>
                                <h1 className={styles.heading}>Сніданки</h1>
                                ...
                                <CategoryBlock
                                    ...
                                    {...{
                                        ...props.blocks.find(
                                            (block) => block.blockName === BlockNames.breakfast
                                        )
                                    }}
                                />
                                <CategoryBlock
                                    ...
                                    {...{
                                        ...props.blocks.find(
                                            (block) => block.blockName === BlockNames.seafoodPlato
                                        ),
                                ...
                                <CategoryBlock
                                    ...
                                    {...{
                                        ...props.blocks.find(
                                            (block) => block.blockName === BlockNames.sweetBreakfast
                                        )
                                    }}
                                />
                            </section>,
                            <section key={2}>
								{ hour <=8 || hour <= 12 ? <h1 className={styles.heading}>Основне меню</h1> : null }
                                <CategoryBlock
                                    key={BlockNames.oysterBar}
                                    {...{
                                        ...props.blocks.find(
